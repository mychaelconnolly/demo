...
- The financial research prototype loads committed fixture JSON from `financial-research/data/research-demo.json`; live Yahoo/SEC fetching happens offline before deploy.
